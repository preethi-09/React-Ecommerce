...
<form method="post" id="addproduct" action="{{ route('product.store') }}" enctype="multipart/form-data"> 
	 @csrf
...
<div class="border border-3 p-4 rounded">
  <div class="row g-3">
	<div class="col-md-6">
		...
		<input type="text" name="price" class="form-control" id="inputPrice" placeholder="0000">
	  </div>


	  <div class="col-md-6">
		<label for="inputCompareatprice" class="form-label">Special Price</label>
		<input type="text" name="special_price" class="form-control" id="inputCompareatprice" placeholder="0000" >
	  </div>
	  ...
	  <div class="col-12">
		...
		<input type="text" name="brand" class="form-control" id="inputCompareatprice" placeholder="">
	  </div>
